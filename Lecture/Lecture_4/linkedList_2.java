...
public class linkedList_2 {
    ...
    public static void main(String[] args) {
        ...
        earlBio.add(str1);
        earlBio.add(str3);
        earlBio.add(1, str2); // добавили на index 1

        System.out.println(earlBio); // [Hello World!, My name is Earl, I love Java]



        // удаление по index LinkedList списка
        String str1_1 = new String("Hello World!");
        String str2_1 = new String("My name is Earl");
        String str3_1 = new String("I love Java");
        // String str4_1 = new String("I live in Moscow"); // строка не использовалась в коде

        LinkedList<String> earlBio_1 = new LinkedList<>();
        earlBio_1.add(str1_1);
        earlBio_1.add(str3_1);
        earlBio_1.add(1, str2_1); // добавили на index 1

        earlBio_1.remove(1); // удалили с index 1

        System.out.println(earlBio_1); // [Hello World!, I love Java]


        // добавления элемента в начало/конец списка
        LinkedList<String> cars = new LinkedList<>();
        String ferrari = new String("Ferrari 360 Spider");
        String bugatti = new String("Bugatti Veyron");
        String Lamborghini = new String("Lamborghini Diablo");
        String ford = new String("Ford Mondeo");
        String fiat = new String("Fiat Ducato");

        cars.add(ferrari);
        cars.add(bugatti);
        cars.add(Lamborghini);
        System.out.println(cars); // [Ferrari 360 Spider, Bugatti Veyron, Lamborghini Diablo]

        cars.addFirst(ford);
        cars.addLast(fiat);
        System.out.println(cars); // [Ford Mondeo, Ferrari 360 Spider, Bugatti Veyron, Lamborghini Diablo, Fiat Ducato]


        // возвращают первый/последний элемент списка
        LinkedList<String> cars_1 = new LinkedList<>();
        String ferrari_1 = new String("Ferrari 360 Spider");
        String bugatti_1 = new String("Bugatti Veyron");
        String Lamborghini_1 = new String("Lamborghini Diablo");

        cars_1.add(ferrari_1);
        cars_1.add(bugatti_1);
        cars_1.add(Lamborghini_1);
        System.out.println(cars_1); // [Ferrari 360 Spider, Bugatti Veyron, Lamborghini Diablo]
        ...
        String ferrari_2 = new String("Ferrari 360 Spider");
        String bugatti_2ferrari_2 = new String("Bugatti Veyron");
        String Lamborghini_2ferrari_2 = new String("Lamborghini Diablo");
        ...
        System.out.println(cars_2); // [Bugatti Veyron]
