...
public class bubbleSort {
    ...
    public static void main(String[] args) {
        ...
        while (needIteration) { // внешний цикл цикл while определен как true, он работает.
            ...
            for (int i = 1; i < array.length; i++) { // проход по всей длине массива, index 1.
	            ...
	            if (array[i] < array[i - 1]) { // ТУТ ВАЖНО, если цикл НЕ НАЙДЕТ элементы верные не равенству, то массив отсортирован -> ВЫХОД.
                                            // если находим элемент массива верный не равенству, то...
