...
public class BinaryFile {
    ...
    static void writeInt(OutputStream out, int num) throws IOException {
        ByteBuffer dyBuf = ByteBuffer.allocate(4);
        dyBuf.order(bOrder).putInt(num);
        out.write(dyBuf.array());
    }

    public static void main(String[] args) {
        String file = "/Users/Medwed_SA/Desktop/Education/" +
                "Java/project_IntelliJ_IDEA/Java_GB/src/main/java/ru/medwedSA/" +
                "Java_Core_GB/Lectures/Lecture_2/test.bin";
        //create file
